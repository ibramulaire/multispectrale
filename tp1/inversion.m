function res = inversion (I)  % fonction qui prend en paramètre une image I% et retourne une image res (negatif)
[m, n, can] = size(I);  % m=nb lignes, n=nb colonnes, 
res = zeros (m, n);     % image résultante (de même taille que I) : % initialisée à 0 partout
if(can > 1)
    I = rgb2gray(I);    % si l’image est en couleur, la transformer en NG
end
res = 255 - I;          % l’inversion
figure %divise la fenêtre en 1 ligne et 2 colonnes : pour afficher 2 images l'une%à côté de l'autre
