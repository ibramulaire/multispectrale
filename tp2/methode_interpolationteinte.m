function Output_RGB= methode_interpolationteinte(Image_CFA)
        ...
        if(i==true)
            ...
            for c=2:nbcol+1  
                if(j==true)
                    ...
                    B(l-1,c-1)=(G(l-1,c-1)*((Image_CFA(l-1,c-1)/G( l-1,c-2))+(Image_CFA(l-1,c+1)/G(l-2,c))+(Image_CFA(l+1,c-1)/G(l,c-2))+(Image_CFA(l+1,c+1)/G(l,c))))/4;
                    ...
                    B(l-1,c-1)=(G(l-1,c-1)*((Image_CFA(l-1,c)/G(l-2,c-1))+(Image_CFA(l+1,c)/G(l,c-1))))/2;
                  
                    R(l-1,c-1)=(G(l-1,c-1)*((Image_CFA(l,c-1)/G(l-1,c-2))+(Image_CFA(l,c+1)/G(l-1,c))))/2;
